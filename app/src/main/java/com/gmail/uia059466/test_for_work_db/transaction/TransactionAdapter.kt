...
class TransactionAdapter(
    ...
    inner class CaptionViewHolder(itemView: View) :
            BaseViewHolder<DisplayTransaction.Header>(itemView) {
    ...
    inner class MainViewHolder(itemView: View) :
            BaseViewHolder<DisplayTransaction.TransactionDisplay>(itemView) {
        ...
        private val tvAmountCurrency: TextView = itemView.findViewById(R.id.currency_amount_tv)

        private lateinit var currentItem: DisplayTransaction.TransactionDisplay
        ...
        override fun bind(item: DisplayTransaction.TransactionDisplay) {
            ...
            if (item.amountCurrency.isNotBlank()) {
                tvAmountCurrency.visibility = View.VISIBLE
                tvAmountCurrency.text = item.amountCurrency
            }
